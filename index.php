...
<head>
  ...
  <title>Application Rate Limiter UI</title>
  <link rel="stylesheet" href="style/style.css" type="text/css" media="screen" />
  <!--script type="text/javascript" src="style/accordian.pack.js"></script-->
</head>

<body>
  <div id="name"><h1>Application Rate Limiter</h1></div>
  <div id="basic-container" >
    <div id="test-header" class="container_headings header_highlight">Home</div>
    <div id="test-content">
      <div class="container_child">
        <h1>Please indicate how much bandwidth you wish to allow for each type of application.</h1>
        <?php
        $updated=false;
  ...
  <div id="footer">
    <p>CS8001 SDN | <a href="http://projectbismark.net/">Project BISmark</a></p>
  </div>
</body>
</html>
